					...
					<Table>
						<TableHead>
							<TableRow>
								...
								<TableCell align="center">관리자 권한</TableCell>
						...
						<TableBody>
							<TableRow style={{cursor: 'pointer'}} onClick={() => onClickItem(0)}>
								...
								<TableCell align="center">abc@abc.com</TableCell>
								<TableCell align="center">마스터</TableCell>
								<TableCell align="center">
									<Box display="flex" flexDirection="row" justifyContent="center">
										<Button variant="outlined" color="primary" size="small">권한</Button>
										<Box m={0.2}/>
